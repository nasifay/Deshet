    ...
    projects: [
      {
        id: 1,
        name: "YCI YNSD",
        description: "Youth Challenge Initiative implemented by Youth Network for Sustainable Development. Focuses on SRH awareness, health-seeking behavior, entrepreneurship skills, and sustainable business model for reusable sanitary pads.",
        featuredImage: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=400&h=400&fit=crop&crop=center",
      ...
      },
      {
        id: 2,
        name: "Peace - NORAD",
        description: "Peacebuilding project funded by Norwegian Agency for Development Cooperation. Aims to raise awareness on peacebuilding, conflict prevention, and social cohesion among communities.",
        featuredImage: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 3,
        name: "ERASE EILDA",
        description: "Enhance resilience against online and offline violence in the society of Ethiopia. Fosters trust through dialogue and establishes community monitoring networks.",
        featuredImage: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop&crop=center",
      ...
      },
      {
        id: 4,
        name: "VAC CRVPF",
        description: "Violence Against Children project under Children's Rights and Violence Prevention Fund. Strengthens parenting skills and creates supportive family environments.",
        featuredImage: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&h=400&fit=crop&crop=center",
      ...
      },
      {
        id: 5,
        name: "YDP - TSD",
        description: "Youth Development Program implemented by Tamra Sustainable Development. Comprehensive youth development initiative focusing on leadership and community engagement.",
        featuredImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=center",
    ...
    projects: [
      {
        id: 1,
        name: "GBV - NCA",
        description: "Gender-Based Violence prevention project funded by Norwegian Church Aid. Improves social norms and attitudes toward ending violence against women and girls within school communities.",
        featuredImage: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 2,
        name: "Safe City NCA",
        description: "Creating safe urban environments for women and girls. Engages men, boys, and volunteers in promoting positive masculinity and equitable social norms.",
        featuredImage: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 3,
        name: "SRHR - Sonke",
        description: "Sexual and Reproductive Health and Rights project with Sonke Gender Justice. Empowers women, girls, and marginalized groups to make informed decisions about SRHR.",
        featuredImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 4,
        name: "GESI - GIZ",
        description: "Gender Equality and Social Inclusion project with German Development Cooperation. Focuses on SRH awareness, entrepreneurship, and reusable sanitary pads (2017-2025).",
        featuredImage: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 5,
        name: "SRHR Ipas",
        description: "Sexual and Reproductive Health and Rights project with Ipas. Raises awareness among factory workers on SRHR, safe abortion, contraception, and SGBV prevention.",
        featuredImage: "https://images.unsplash.com/photo-1544717297-fa95b6ee9643?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
    ...
    projects: [
      {
        id: 1,
        name: "Climate - NCA",
        description: "Climate adaptation and mitigation project with Norwegian Church Aid. Builds community resilience against climate change impacts and promotes sustainable practices.",
        featuredImage: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&h=400&fit=crop&crop=center",
      ...
      },
      {
        id: 2,
        name: "Livelihood NCA",
        description: "Sustainable livelihood development project. Creates economic opportunities that support both people and environmental sustainability.",
        featuredImage: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=400&fit=crop&crop=center",
      ...
      },
      {
        id: 3,
        name: "CSPW - YNSD",
        description: "Climate Smart Practices for Women implemented by Youth Network for Sustainable Development. Empowers women with climate-resilient agricultural practices.",
        featuredImage: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
            src: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&h=400&fit=crop&crop=center",
      ...
      },
      {
        id: 4,
        name: "W4V - NCA",
        description: "Water for Vulnerable Communities project. Ensures access to clean water and promotes water conservation practices in vulnerable communities.",
        featuredImage: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 5,
        name: "IRWA",
        description: "Integrated River Watershed Management project. Focuses on comprehensive watershed management and environmental protection.",
        featuredImage: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
      ...
      },
      {
        id: 6,
        name: "Envt TSD",
        description: "Environmental protection project by Tamra Sustainable Development. Promotes environmental conservation and sustainable development practices.",
        featuredImage: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&h=600&fit=crop&crop=center",
        galleryThumbnails: [
          {
            id: 1,
  ...
  try {
    ...
    programsData.forEach((program, index) => {
      ...
      program.projects.forEach(project => {
        console.log(`     - ${project.name} (${project.partner}) - ${project.status}`);
      });
      console.log('');
    });
