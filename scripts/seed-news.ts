...
const newsData = [
  {
    ...
    excerpt:
      "Tamra NGO joyfully celebrated the Ethiopian New Year together with community members, partners, and staff.",
...
<p>Looking forward, Tamra NGO aims to expand its impact, reaching more vulnerable communities and creating sustainable solutions for lasting change.</p>`,
  ...
  },
  {
    ...
    excerpt:
      "Tamra for Social Development (TSD) has kicked off a week-long Youth Leadership Training in Hawassa aimed at empowering young leaders in the community.",
...
<p>This initiative is part of TSD's ongoing commitment to investing in the next generation of leaders who will drive sustainable development and social change in Ethiopia.</p>`,
  ...
  },
  {
    ...
    excerpt:
      "Our comprehensive community health program has successfully reached over 500 families, providing essential healthcare services and education.",
...
<p>The program has shown remarkable results, with significant improvements in community health indicators and increased awareness of preventive healthcare measures among beneficiaries.</p>`,
  ...
  },
  {
    ...
    excerpt:
      "The three-month women's empowerment workshop series concluded with over 150 women gaining new skills in entrepreneurship and financial literacy.",
...
<p>This program demonstrates TSD's commitment to gender equality and economic empowerment, creating pathways for women to achieve financial independence and contribute to their communities' economic development.</p>`,
  ...
  {
    title:
      "Educational Support Program Helps 200 Students Continue Their Studies",
    slug: "educational-support-program-helps-200-students",
    excerpt:
      "Through our educational support program, 200 students from vulnerable backgrounds received scholarships and school supplies to continue their education.",
...
<p>We believe that education is the foundation for breaking the cycle of poverty, and this program is a testament to our commitment to ensuring every child has the opportunity to learn and succeed.</p>`,
  ...
  },
  {
    ...
    excerpt:
      "TSD's clean water initiative has successfully installed water points in three villages, providing clean drinking water to over 1,000 households.",
...
<p>The project also includes water management training for community members, ensuring the sustainability of these water systems for years to come.</p>`,
  ...
  },
  {
    ...
    excerpt:
      "TSD announces strategic partnerships with five local NGOs to expand the reach and impact of community development programs.",
...
<p>This collaborative approach reflects our belief that sustainable development requires coordinated action from multiple stakeholders working towards common goals.</p>`,
  ...
  },
  {
    ...
    excerpt:
      "Farmers who participated in TSD's agricultural training program reported an average income increase of 40% through improved farming techniques.",
...
async function seedNews() {
  ...
  try {
    ...
    console.log(
      `Published posts: ${
        newsWithAuthor.filter((n) => n.status === "published").length
      }`
    );
    console.log(
      `Featured posts: ${newsWithAuthor.filter((n) => n.isFeatured).length}`
    );
    console.log("─".repeat(50));
