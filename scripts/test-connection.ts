...
async function testConnection() {
  try {
    ...
    console.log(`Collections in "${mongoose.connection.db.databaseName}" database:`, collections.length);
    ...
    if (error.message.includes('authentication')) {
      ...
      console.error('   3. Edit your user and ensure they have "readWrite" permissions');
