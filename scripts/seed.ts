...
import { coreValues, leadershipTeam, targetGroups, operationRegions } from '../lib/data/who-we-are-data';
    ...
    if (existingSettings) {
      ...
      await SiteSettings.create({
        ...
        supporters: [
          ...
          { name: 'Norwegian Church Aid', logo: '/suporters/norwegian-church.png' },
          ...
          { name: 'Sonke Gender Justice', logo: '/suporters/sonke-gender-justice.png' },
          { name: 'Search for Common Ground', logo: '/suporters/search-for-common-ground.png' },
      ...
      const programs = [
        {
          ...
          thumbnails: [
            { id: 1, src: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=400&h=400&fit=crop' },
            { id: 2, src: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop' },
            { id: 3, src: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&h=400&fit=crop' },
            { id: 4, src: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop' },
          ],
          status: 'published',
          order: 1,
      ...
      const pageData = [
        {
          ...
          seo: {
            ...
            metaDescription: 'Learn about TSD, an Ethiopian civil society organization focused on youth empowerment, peacebuilding, SRH, gender development, and climate justice since 1998.',
            keywords: ['TSD', 'about', 'youth empowerment', 'peacebuilding', 'Ethiopia', 'civil society'],
          },
        },
        {
          title: 'Contact Us',
          ...
          seo: {
            ...
            metaDescription: 'Contact Tamra Social Development Organization. Phone: +251 911 121314, Email: hello@tsd.com. Located in Addis Ababa, Ethiopia.',
            keywords: ['contact', 'TSD', 'phone', 'email', 'Addis Ababa', 'Ethiopia'],
          },
        },
        {
          title: 'Donate',
          ...
          seo: {
            ...
            metaDescription: 'Support TSD\'s mission to empower youth, uplift women, and strengthen communities. Multiple banking options available for donations.',
            keywords: ['donate', 'support', 'TSD', 'banking', 'charity', 'Ethiopia'],
          },
        },
        {
          title: 'Gallery',
          ...
          seo: {
            ...
            metaDescription: 'Browse TSD\'s photo gallery showcasing our programs, community impact, and transformative work across Ethiopia.',
            keywords: ['gallery', 'photos', 'TSD', 'programs', 'community', 'impact'],
          },
        },
        {
          title: 'History',
          ...
          seo: {
            ...
            metaDescription: 'Discover TSD\'s history from its founding in 1998 as an Anti-AIDS club to becoming a leading civil society organization in Ethiopia.',
            keywords: ['history', 'TSD', '1998', 'milestones', 'journey', 'Ethiopia', 'civil society'],
          },
        },
        {
          ...
          seo: {
            ...
            metaDescription: 'Join TSD as a volunteer and help create lasting change in communities. Multiple volunteer opportunities available across Ethiopia.',
            keywords: ['volunteer', 'TSD', 'community', 'service', 'opportunities', 'Ethiopia'],
          },
        },
      ];
