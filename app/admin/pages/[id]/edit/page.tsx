    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 dark:text-white">Edit Page</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400">Last updated: {new Date(page.updatedAt).toLocaleString()}</p>
          </div>
        </div>
