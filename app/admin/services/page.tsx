    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Manage your medical services by category
          </p>
        </div>
        <Link
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <option value="detox-cleansing">
              Detox & Cleansing Therapy
            </option>
            <option value="diagnostic">Traditional Diagnostic Techniques</option>
            <option value="healing-treatments">Healing Treatments</option>
          </select>
        </div>
      </div>
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          Object.keys(groupedServices).map((categoryLabel) => (
            <div
              key={categoryLabel}
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {groupedServices[categoryLabel].map((service: Service) => (
                      <tr
                        key={service._id}
