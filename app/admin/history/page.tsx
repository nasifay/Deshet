      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Manage your organization&apos;s history content
          </p>
        </div>
        <Link
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-medium text-blue-800 dark:text-blue-300">
              Published History Display
            </h3>
            <p className="mt-1 text-sm text-blue-700 dark:text-blue-400">
              The most recently published history entry will be displayed on the
              frontend history page. You can have multiple versions but only the
              latest published one will be shown.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center">
            ...
            <Link
              href="/admin/history/new"
              className="inline-flex items-center space-x-2 mt-4 px-4 py-2 bg-primary-green text-white rounded-lg hover:bg-green-700 transition-colors"
            >
              <Plus className="w-5 h-5" />
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <span className="text-sm text-gray-900 dark:text-white">
                          {entry.heroImages.length}
                        </span>
                        <span className="text-xs text-gray-500 dark:text-gray-400">
                          image{entry.heroImages.length !== 1 ? "s" : ""}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end space-x-2">
                        <Link
                          href={`/admin/history/${entry._id}/edit`}
