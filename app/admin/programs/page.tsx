  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-gray-900 dark:text-white">Programs</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage your programs by category</p>
        </div>
        <Link
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <option value="youth-empowerment">Youth Empowerment & Peacebuilding</option>
            <option value="srh-gender">SRH & Gender Development</option>
            <option value="climate-justice">Climate Justice & Livelihoods</option>
          </select>
        </div>
      </div>
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          Object.keys(groupedPrograms).map((categoryLabel) => (
            <div key={categoryLabel} className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
              <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">{categoryLabel}</h2>
              </div>
                ...
                <table className="w-full">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {groupedPrograms[categoryLabel].map((program: Program) => (
                      <tr key={program._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
