      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Manage testimonials from supporters and partners
          </p>
        </div>
        <Link
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-blue-700 dark:text-blue-400">
              Testimonials marked as{" "}
              <span className="font-semibold">Featured</span> will be displayed
              on the landing page. Use the order field to control their
              position.
            </p>
          </div>
        </div>
                      ...
                      <div className="flex items-start">
                        <div>
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400 italic">
                            &ldquo;{truncateText(testimonial.quote, 80)}&rdquo;
                          </div>
                        </div>
                      </div>
                    </td>
