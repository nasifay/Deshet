        ...
        <div className="bg-white rounded-[46px] border border-border shadow-sm px-5 py-10 md:px-12 md:py-14 lg:px-[65px] lg:py-[88px]">
          <div className="mx-auto w-full max-w-[1400px] grid lg:grid-cols-[minmax(0,632px)_minmax(0,649px)] items-center gap-10 lg:gap-[119px]">
            ...
            <div className="w-full lg:w-[632px] space-y-6 lg:space-y-[63px]">
              <div>
                <p className="text-[40px] sm:text-[56px] lg:text-[72px] font-black text-primary uppercase leading-[1.05] tracking-[0]">About Us</p>
              </div>
              <div className="text-gray-700 leading-relaxed text-base md:text-[18px]">
                <p>
                ...
                <p className="mt-3">
                  With <span className="text-accent font-semibold">25+ years</span> of impact, we drive change through grassroot engagement, advocacy, and community-driven solutions.
                </p>
              </div>
              <div>
            ...
            <div className="w-full lg:w-[649px]">
              <div className="relative w-full h-[280px] sm:h-[360px] md:h-[440px] lg:h-[538px] rounded-[46px] overflow-hidden">
